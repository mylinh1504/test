...
if ( class_exists( 'WP_Customize_Control' ) ) {
	 ...
	 */
	class Legal_News_Toggle_Switch_Custom_Control extends WP_Customize_Control {
		/**
	 ...
	 */
	class Legal_News_Customize_Horizontal_Line extends WP_Customize_Control {
		/**
		 * Control Type
		 */
		public $type = 'hr';
...
if ( class_exists( 'WP_Customize_Section' ) ) {
	 ...
	 * Upsell section
	 */
	class Legal_News_Upsell_Section extends WP_Customize_Section {
		/**
		 * The type of control being rendered
		 */
		public $type = 'legal-news-upsell';
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="legal_news_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
